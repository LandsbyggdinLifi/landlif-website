...
export default async function Page() {
  ...
  if (pages.length > 0) {
    redirect(`/starfid/samstarf-erlendis/${pages[0].slug.current}`);
  }
  ...
  return (
    <StarfidLayout title={page?.title || "Samstarf Erlendis"} section="samstarf-erlendis" heroImage={page?.heroImage} subNavLinks={subNavLinks} navLayout="horizontal">
      {page?.body ? (
