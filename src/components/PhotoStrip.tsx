    ...
    <section className="py-12 bg-white">
      <div className="max-w-6xl mx-auto px-6 mb-6 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => scroll("left")}
            className="w-8 h-8 rounded-full flex items-center justify-center text-lg leading-none shadow-sm border border-gray-200 hover:border-teal transition-colors"
            style={{ color: "var(--navy)" }}
